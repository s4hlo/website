      ...
      skills: [
        {
          name: 'NestJS',
          level: 95,
          description: 'Framework Node.js para aplicações escaláveis e eficientes',
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          ...
          tags: ['Supervised Learning', 'Neural Networks', 'Data Preprocessing']
        },
        {
          name: 'LLMs & AI',
          level: 80,
            ...
            >
              ...
              <Stack spacing={2} sx={{ height: '100%' }}>
                {category.skills.map((skill) => (
                  <Box key={skill.name} sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <Box sx={{ 
            ...
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" gutterBottom>Performance First</Typography>
            ...
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" gutterBottom>Security Expert</Typography>
              <Typography variant="body2" color="text.secondary">
            ...
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" gutterBottom>Clean Architecture</Typography>
              <Typography variant="body2" color="text.secondary">
